...
def preprocess_ke_speech():
    ...
    # For instance, if you don't want to use the train_phase2 subpart, just remove
    # the line below containing "train_phase2"
    dataset_parts = (
        "dev_phase1", "dev_phase2", "test", "train_phase1", "train_phase2"
    )
    ...
    for partition, m in manifests.items():
        ...
        if partition not in ["dev_phase1", "dev_phase2", "test"]:
            logging.info(
